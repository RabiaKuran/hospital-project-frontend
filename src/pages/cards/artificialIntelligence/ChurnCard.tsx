...
export default function ChurnCard(props: IChurnProps) {
            ...
            <AGridItem xs={12}>
                {alert1 &&
                    <Alert icon={<CommentIcon style={{ fontSize: 75, color: "#0073B0" }} />} style={{ fontSize: 30, color: "#0073B0", display: "flex", alignItems: "center", background: "rgba(30,144,255,0.2)", paddingTop: 20, paddingBottom: 20 }}>
                        <AlertTitle style={{ fontSize: 40 }}>Churn Analysis</AlertTitle>
                        Churn analysis is the process of analyzing your data to understand why customers have stopped using your product.
                        This analysis helps to identify customers who are at risk of losing. So you can identify them before it's too
                        late and start working to reverse the customer loss. Churn analysis determines the success of your company.
                    </Alert>
            ...
            <AGridItem xs={12}>
                {alert2 &&
                    <Alert icon={<AdbIcon style={{ fontSize: 87, color: "#696969" }} />} style={{ fontSize: 30, color: "#696969", display: "flex", alignItems: "center", background: "rgba(105,105,105,0.2)", paddingTop: 20, paddingBottom: 20 }}>
                        ...
                        as possible, but churn analysis can take a long time.
                    </Alert>
                }
            </AGridItem>
            <AGridItem xs={12}>
            ...
            <AGridItem xs={12}>
                {alert4 &&
                    <Alert id="alert3" icon={<UpdateIcon style={{ fontSize: 75, color: "#FF8C00" }} />} style={{ fontSize: 30, color: "#FF8C00", display: "flex", alignItems: "center", background: "rgba(255,165,0, 0.2)", paddingTop: 30, paddingBottom: 30 }}>
                        It's almost over. I will present the results of the churn analysis you requested.
                    </Alert>
                }
            </AGridItem>
            <AGridItem xs={12}>
                {alert5 &&
                    <Alert id="alert4" icon={<TaskAltIcon style={{ fontSize: 70, color: "#008000" }} />} style={{ fontSize: 30, color: "#008000", display: "flex", alignItems: "center", background: "rgba(49, 180, 45, 0.2)", paddingTop: 30, paddingBottom: 30 }} >
                        IT'S DONE! I AM COMPLETED THE CHURN ANALYSIS. YOU CAN SEE THE ANALYSIS RESULTS ON THE CUSTOMER
