      ...
      >
        <AGridItem xs={3}>
          <AButton
            ...
            style={{
              background:
                "linear-gradient(90deg, rgba(19,98,173,1) 0%, rgba(23,112,199,1) 38%, rgba(21,121,218,1) 68%)",
        ...
        {dataSource1 && <PersonalProductsCard button={button1} />}
        {dataSource2 && <FoodSectionCard button={button2} />}
        {dataSource3 && <FloorInformationCard button={button3} />}
        {dataSource4 && <GeneralInformationCard button={button4} />}
      </AGrid>
    </>
  );
}
