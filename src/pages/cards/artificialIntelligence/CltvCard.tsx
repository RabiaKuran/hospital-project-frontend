...
export default function CltvCard(props: ICltvProps) {
    ...
    return (
        <>
            ...
            <AGridItem xs={12}>
                {alert1 &&
                    <Alert icon={<CommentIcon style={{ fontSize: 75, color: "#0073B0" }} />} style={{ fontSize: 30, color: "#0073B0", display: "flex", alignItems: "center", background: "rgba(30,144,255,0.2)", paddingTop: 20, paddingBottom: 20 }}>
                        <AlertTitle style={{ fontSize: 40 }}>CLTV Analysis</AlertTitle>
                        The lifetime value analysis tells you how valuable a customer is to your brand. It can help you
                        focus on long-term profits. By identifying low-level and mid-level customers, you can develop marketing
                        strategies to turn them into long-term loyal customers. You can also reward your best customers for their
                        loyalty, making them feel valued.
                    </Alert>
            ...
            <AGridItem xs={12}>
                {alert2 &&
                    <Alert icon={<AdbIcon style={{ fontSize: 87, color: "#696969" }} />} style={{ fontSize: 30, color: "#696969", display: "flex", alignItems: "center", background: "rgba(105,105,105,0.2)", paddingTop: 20, paddingBottom: 20 }}>
                        ...
                        as possible, but cltv analysis can take a long time.
                    </Alert>
                }
            </AGridItem>
            <AGridItem xs={12}>
                {alert3 &&
                    <Alert icon={<ContentPasteSearchIcon style={{ fontSize: 75, color: "#A64DA6" }} />} style={{ fontSize: 30, color: "#A64DA6", display: "flex", alignItems: "center", background: "rgba(152,45,223,0.1)", paddingTop: 30, paddingBottom: 30 }}>
            ...
            <AGridItem xs={12}>
                {alert4 &&
                    <Alert icon={<UpdateIcon style={{ fontSize: 75, color: "#FF8C00" }} />} style={{ fontSize: 30, color: "#FF8C00", display: "flex", alignItems: "center", background: "rgba(255,165,0, 0.2)", paddingTop: 30, paddingBottom: 30 }}>
                        It's almost over. I will present the results of the cltv analysis you requested.
                    </Alert>
                }
            </AGridItem>
            <AGridItem xs={12}>
                {alert5 &&
                    <Alert icon={<TaskAltIcon style={{ fontSize: 70, color: "#008000" }} />} style={{ fontSize: 30, color: "#008000", display: "flex", alignItems: "center", background: "rgba(49, 180, 45, 0.2)", paddingTop: 30, paddingBottom: 30 }} >
                        IT'S DONE! I AM COMPLETED THE CLTV ANALYSIS. YOU CAN SEE THE ANALYSIS RESULTS ON THE CUSTOMER
